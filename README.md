<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/vjt/decaf@v0.3.6/doc/img/logo.png" alt="decaf logo" width="180">
</p>
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/vjt/decaf@v0.3.6/doc/img/cover.png" alt="Mascetti, Mosconi e Magnotta alle prese con la dichiarazione dei redditi">
</p>
...
📖 **Manuale completo**: [doc/decaf_manual.pdf](https://cdn.jsdelivr.net/gh/vjt/decaf@v0.3.6/doc/decaf_manual.pdf) — guida fiscale, normativa con riferimenti alla Gazzetta Ufficiale, architettura, internals per broker, setup Flex Query. Rigenerato ad ogni cambio in `doc/` via pre-commit hook.
...
[📄 PDF](https://cdn.jsdelivr.net/gh/vjt/decaf@v0.3.6/examples/mascetti/decaf_2025.pdf) ·
[📊 Excel](https://cdn.jsdelivr.net/gh/vjt/decaf@v0.3.6/examples/mascetti/decaf_2025.xlsx) ·
[📋 YAML](https://cdn.jsdelivr.net/gh/vjt/decaf@v0.3.6/examples/mascetti/decaf_2025.yaml)
...
|---------------------|:-------:|-------------------------------------------------------------|:-------:|
| `decaf_<year>.xlsx` | Excel   | Un foglio per quadro + riepilogo                            | [xlsx](https://cdn.jsdelivr.net/gh/vjt/decaf@v0.3.6/examples/mascetti/decaf_2025.xlsx) |
| `decaf_<year>.pdf`  | PDF     | Prospetto con tabelle e totali                              | [pdf](https://cdn.jsdelivr.net/gh/vjt/decaf@v0.3.6/examples/mascetti/decaf_2025.pdf) |
| `decaf_<year>.yaml` | YAML    | Dump completo del `TaxReport` — diffabile, stabile tra run  | [yaml](https://cdn.jsdelivr.net/gh/vjt/decaf@v0.3.6/examples/mascetti/decaf_2025.yaml) |
